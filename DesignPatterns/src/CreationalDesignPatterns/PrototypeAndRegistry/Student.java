...
public class Student implements Prototype<Student>{
    ...
    public Student(int id, String name, int psp, String batchName, String moduleName, String track,
                   int joinYear, String instructorName, int completionYear, String paymentPartner,
                   int batchPSP) {
        this.id = id;
        this.name = name;
        this.psp = psp;
    ...
    public boolean equals(Object o){
        ...
        return id == student.id && psp == student.psp && joinYear == student.joinYear &&
                completionYear == student.completionYear && batchPSP == student.batchPSP &&
                Objects.equals(name, student.name) &&
                Objects.equals(batchName, student.batchName) &&
                Objects.equals(moduleName, student.moduleName) &&
                Objects.equals(track, student.track) &&
                Objects.equals(instructorName, student.instructorName) &&
                Objects.equals(paymentPartner, student.paymentPartner);
    }
}
